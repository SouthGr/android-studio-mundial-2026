...
// Tipografía estándar del sistema (la web usa Oswald + Inter vía Google Fonts;
// en Android usamos la fuente del sistema para no depender de descargas de fuentes).
val FifaTypography = Typography(
